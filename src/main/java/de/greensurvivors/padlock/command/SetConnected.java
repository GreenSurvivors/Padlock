...
public class SetConnected extends SubCommand {
    ...
    protected @NotNull Component getHelpText() {
        return plugin.getMessageManager().getLang(LangPath.HELP_SET_CONNECTED);
    }
                    ...
                    if (sign != null) {
                        ...
                        if (SignLock.isOwner(sign, player.getUniqueId()) ||
                            ...
                            if (shouldConnected != null) {
                                ...
                                plugin.getMessageManager().sendLang(sender, LangPath.SET_CONNECTED_SUCCESS,
                                    Placeholder.component(PlaceHolder.ARGUMENT.getPlaceholder(), Component.text(shouldConnected)));
                            } else {
                                plugin.getMessageManager().sendLang(sender, LangPath.NOT_A_BOOL,
