...
public class BlockEnvironmentListener implements Listener {
    ...
    public void onEntityExplode(EntityExplodeEvent event) {
        if (plugin.getConfigManager().isProtectionExempted("explosion")) return;
    ...
    public void onStructureGrow(StructureGrowEvent event) {
        if (plugin.getConfigManager().isProtectionExempted("growth")) return;
    ...
    public void onPistonExtend(BlockPistonExtendEvent event) {
        if (plugin.getConfigManager().isProtectionExempted("piston")) return;
    ...
    public void onBlockRedstoneChange(BlockRedstoneEvent event) {
        if (plugin.getConfigManager().isProtectionExempted("redstone")) return;
